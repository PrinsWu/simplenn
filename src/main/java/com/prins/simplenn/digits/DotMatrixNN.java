 ...
 * @since v1.0 2018/2/2
 */
public class DotMatrixNN {
    private static double learningRate = 0.1;
    private static double randomWeight = 1.0;
    private static final int INPUTSIZE = 8 * 8;
...
//    public static final int LAYER_TWO_SIZE = 2;
    ...
    public DotMatrixNN() {
        //training data
        int trainSize = 20000;
        double[][] trains = DotMatrixDataBuilder.buildTrainingData(trainSize);
        //correct data
        double[][] corrects = DotMatrixDataBuilder.buildCorrectResultData(trainSize);
